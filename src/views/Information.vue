  ...
  <div class="px-3 pt-3 mb-28">
    <div class="max-w-lg mx-auto">
      <div role="alert" class="alert alert-warning mb-4">
        ...
        <span
          >We detect Indian products by identifying barcodes that start with
          890. This prefix indicates the number was originally issued by the
          Indian branch of GS1.</span
        >
      </div>

      <p class="mb-4 text-justify">
        The project aims to help Bangladeshi people to detect Indian products
        quickly and efficiently. Our barcode scanner supports multiple barcode
        formats commonly used for retail products. Use the scanner to identify
        products by their barcode, and you can determine if they are from India.
      </p>

      <p>Barcode formats supported:</p>
      <div class="flex gap-3 flex-wrap">
        <span
          class="border px-4 py-1 rounded-md hover:bg-black hover:text-white transition-all cursor-pointer"
          v-for="format in selectedBarcodeFormats"
          :key="format"
          >{{ format }}</span
        >
      </div>
      ...
      <div class="mt-16 border-t pt-16">
        ...
        <div class="avatar my-4">
          <div class="w-32 rounded-md">
            <img :src="ShihabImg" alt="Md Muhaiminul Islam Shihab" />
          </div>
        </div>
        <h3 class="text-xl font-bold">Md Muhaiminul Islam Shihab</h3>
        <h3 class="font-bold text-[14px]">
          Software Developer (PHP | Laravel | Vue.js)
        </h3>

        <div
          class="bg-white w-full h-auto py-4 flex items-center gap-4 flex-wrap"
        >
          <a
            href="https://facebook.com/muhaiminshihab"
            target="_blank"
          ...
          <a
            href="https://github.com/muhaiminShihab"
            target="_blank"
            class="bg-blue-50 cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-indigo-200"
          >
            <svg
          ...
          <a
            href="https://instagram.com/muhaimin_shihab"
            target="_blank"
          ...
          <a
            href="https://x.com/muhaimin_shihab"
            target="_blank"
          ...
          <a
            href="mailto:hostforshihab@gmail.com"
            target="_blank"
            class="w-12 h-12 flex items-center justify-center bg-gray-100 cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-blue-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
...
import ShihabImg from "../assets/shihab.jpg";
